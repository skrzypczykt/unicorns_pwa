          ...
          <div className="mt-4">
            <div className="relative">
              <button
                type="button"
                disabled
                className="w-full bg-white border-2 border-gray-300 text-gray-400 font-semibold py-3 px-6 rounded-lg flex items-center justify-center gap-3 cursor-not-allowed opacity-60"
              >
              ...
              <div className="absolute top-1/2 right-3 -translate-y-1/2 bg-yellow-100 text-yellow-700 text-xs font-semibold px-2 py-1 rounded-full">
                ⚠️ Wkrótce
              </div>
            </div>
          </div>
